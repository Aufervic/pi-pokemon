...
**📍 HOME PAGE |** la página principal de tu Frontend debe contener:
...
-  Paginado: el listado de pokemones se hará por partes. Tu página debe contar con un paginado que muestre un total de 12 pokemones por página.
