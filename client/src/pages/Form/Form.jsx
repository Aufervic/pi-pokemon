...
const Form = () => {
  ...
  const isFormInvalid = () => {
    return (
      ...
      !!Object.keys(validate(pokemonData)).length
    );
  };
  ...
  const handleClick = (event) => {
    ...
    const tempTypes = pokemonData.types.includes(id)
      ? pokemonData.types.filter((i) => i !== id)
      : [...pokemonData.types, id];
  ...
  const handleSubmit = (event) => {
    ...
    if (isFormInvalid()) {
      ...
      updateModal(
        ...
        "alert",
        "Oops!",
        "No se puede crear Pokemon, ingresa bien los datos"
      );
      return;
    }
      ...
      <form onSubmit={handleSubmit} className={style.form}>
        ...
        <div className={style.propertyContainer}>
          <div className={style.property}>
            ...
            <img
              src={pokemonData.image ? pokemonData.image : PokemonDefaultImage}
              alt="PokeImage"
              onLoad={() => validateImg(true)}
              onError={() => validateImg(false)}
            />
          </div>
        </div>
        <div className={style.propertyContainer}>
              ...
              return (
                <div className={style.typeItem} key={t.id}>
                  <img
                    ...
                    onClick={handleClick}
                    className={
                      pokemonData.types.includes(t.id)
                        ? style.imgSelected
                        : style.imgUnselected
                    }
                  />
        ...
        <button type="submit" disabled={isFormInvalid()} className={style.btn}>
          Create Pokemon
        </button>
      </form>
      <Modal
